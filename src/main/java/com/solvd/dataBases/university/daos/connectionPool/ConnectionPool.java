...
public class ConnectionPool {
    ...
    private BlockingQueue<Connection> connections = new ArrayBlockingQueue<>(MAX_CONNECTIONS);
    ...
    public Connection getConnection() throws FullConnectionPoolException {
        ...
        if((connections.size() < this.MAX_CONNECTIONS) && ((connections.size() - connectionsInUse) == 0)) {
